...
const sliderContainerElement = pictureFormElement.querySelector(
  '.img-upload__effect-level'
);
const effectSliderElement = pictureFormElement.querySelector(
  '.effect-level__slider'
);
const effectsElement = pictureFormElement.querySelector('.effects');
const effectValueElement = pictureFormElement.querySelector(
  '.effect-level__value'
);
